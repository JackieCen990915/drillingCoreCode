...
k=5
#n_estimators
#{'n_estimators': 191}---0.9009819206612704
'''
...
#{'max_depth': 20}---0.9007150391075965----下降了。。。
#随机森林（Random Forest）的max_depth参数的默认值是None
'''
regressor=RandomForestRegressor(n_estimators=191,
                           random_state=90)
GS=GridSearchCV(regressor,param_grid,cv=k)
GS.fit(x_train,y_train)
print(GS.best_params_)
...
#{'max_features': 4}---0.9077873996764483
'''
regressor=RandomForestRegressor(n_estimators=191,
                           max_depth=20,
                           random_state=90)
...
#{'min_samples_leaf': 2}---0.9116528087671769
'''
regressor=RandomForestRegressor(n_estimators=191,
                           max_depth=20,
                           max_features=4,
...
#{'min_samples_split': 5}----0.9116845936469684
'''
regressor=RandomForestRegressor(n_estimators=191,
                           max_depth=20,
                           max_features=4,
